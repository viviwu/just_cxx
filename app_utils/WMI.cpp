...
int main() {
  ...
  hres = pSvc->ExecQuery(
      ...
      NULL,
      &pEnumerator
  );//WHERE AdapterTypeId=0 AND MACAddress IS NOT NULL 、 NetConnectionStatus=2
  ...
  while (pEnumerator) {
    ...
    // Get the value of the Name property :PNPDeviceID、Name、Manufacturer、 NetConnectionStatus、Speed、MACAddress、AdapterType、PhysicalAdapter、NetEnabled
